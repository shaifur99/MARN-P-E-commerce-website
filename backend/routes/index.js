...
// Import SSLCommerz payment controllers
const { 
    initiatePayment, 
    paymentSuccess, 
    paymentFail, 
...
const { orderController, allOrderController } = require('../controller/order/order.controller')
...
router.post('/payment/initiate', authToken, initiatePayment)
